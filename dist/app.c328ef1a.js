...
registerStorage();
},{"@firebase/app":"node_modules/@firebase/app/dist/esm/index.esm2017.js","@firebase/util":"node_modules/@firebase/util/dist/index.esm2017.js","@firebase/component":"node_modules/@firebase/component/dist/esm/index.esm2017.js"}],"node_modules/firebase/storage/dist/esm/index.esm.js":[function(require,module,exports) {
"use strict";
...
function upload(selector) {
  ...
  var files = [];
  var onUpload = (_options$onUpload = options.onUpload) !== null && _options$onUpload !== void 0 ? _options$onUpload : nope;
  var nope = function nope() {};
  var input = document.querySelector(selector);
  var preview = createElement('div', ['preview']);
  var open = createElement('button', ['btn'], 'Open');
  var upload = createElement('button', ['btn', 'primary'], 'Upload');
...
var storage = (0, _storage.getStorage)(app, 'fileuploader-c8b98.appspot.com');
(0, _upload.upload)('#file', {
  ...
  onUpload: function onUpload(files, blocks) {
    files.forEach(function (file, index) {
      ...
      (0, _storage.uploadBytesResumable)(storageRef, file).then(function (snapshot) {
